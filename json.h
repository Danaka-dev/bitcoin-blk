...
template <> bool isType_<bool>( const Value &i ) { return i.IsBool(); }
template <> bool isType_<int>( const Value &i ) { return i.IsInt(); }
template <> bool isType_<unsigned int>( const Value &i ) { return i.IsUint(); }
template <> bool isType_<int64_t>( const Value &i ) { return i.IsInt64(); }
template <> bool isType_<uint64_t>( const Value &i ) { return i.IsUint64(); }
template <> bool isType_<double>( const Value &i ) { return i.IsDouble(); }
template <> bool isType_<const char*>( const Value &i ) { return i.IsString(); }

///--
template <typename T>
T getType_( const Value &value );

template <> bool getType_<bool>( const Value &i ) { return i.GetBool(); }
template <> int getType_<int>( const Value &i ) { return i.GetInt(); }
template <> unsigned int getType_<unsigned int>( const Value &i ) { return i.GetUint(); }
template <> int64_t getType_<int64_t>( const Value &i ) { return i.GetInt64(); }
template <> uint64_t getType_<uint64_t>( const Value &i ) { return i.GetUint64(); }
template <> double getType_<double>( const Value &i ) { return i.GetDouble(); }
template <> const char *getType_<const char*>( const Value &i ) { return i.GetString(); }
